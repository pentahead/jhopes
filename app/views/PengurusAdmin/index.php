<div class="container1">
    ...
    <div class="container2">
        ...
        <div class="judul"> Pengurus Panti</div>
        <div class="row">
            <div class="col-md-4">
                <div class="card" id="editableCard">
                    <img src="<?= BASEURL; ?>/img/admin/DetailPantiAdmin/pengurus.jpg" class="card-img-top gambar-card" alt="...">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <h5 class="card-title fw-bold fs-5">Card title 1</h5>
                        </div>
                        <div class="d-flex gap-3">
                            <div class="btn btn-sm btn-primary rounded-pill px-4">34 Tahun</div>
                            <div class="btn btn-sm btn-primary rounded-pill px-4">Laki-Laki</div>
                        </div>
                        
                        <div class="informasi-tambahan">
                            <p class="email">Email: <span style="color: #0866FF;">jokotyo98@gmail.com</span></p>
                            <p class="alamat">Alamat: <span style="color: #0866FF;">Jl. Halmahera No.11</span></p>
                        </div>
                    </div>
                </div>
            </div>
